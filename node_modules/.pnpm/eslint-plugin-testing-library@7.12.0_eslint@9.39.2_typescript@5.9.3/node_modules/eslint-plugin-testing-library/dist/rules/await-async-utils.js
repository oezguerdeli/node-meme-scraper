                ...
                if (references.length === 0) {
                    if (!(0, node_utils_1.isPromiseHandled)(callExpressionIdentifier)) {
                        context.report({
                            ...
                            fix: (fixer) => {
                                const referenceNode = (0, node_utils_1.getReferenceNode)(callExpressionIdentifier);
                                const awaitFix = insertAwaitBeforeNode(fixer, referenceNode);
                                return (0, add_async_to_function_fix_1.addAsyncToFunctionFix)(fixer, awaitFix, functionExpression);
                            },
                        });
                    }
                }
